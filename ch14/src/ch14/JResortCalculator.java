...
public class JResortCalculator extends JFrame implements ItemListener{
	...
	JLabel optionExplainedLabel1 = new JLabel("Base price for a room is $" + BASE_PRICE + ".");
	JLabel optionExplainedLabel2 = new JLabel("Check the options you want.");
	...
	public JResortCalculator() {
		...
		add(resortLabel);
		add(optionExplainedLabel1);
		add(optionExplainedLabel2);
		add(weekendBox);
		add(breakfastBox);
		add(golfBox);
		add(priceLabel);
